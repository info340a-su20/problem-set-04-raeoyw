...
let seasonOpponents = huskyGames2016.map(extractOpponent);
console.log(seasonOpponents);
...
let winOpponents = lostGames.map(extractOpponent);
console.log(winOpponents);
...
let fumblesGames = huskyGames2016.filter(function(game) {
  return game.fumbles > 0;
});
console.log(fumblesGames.length);
